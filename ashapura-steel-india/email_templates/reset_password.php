<?php 
$site_path = 'http://defoff.com';
$message='  
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Welcome to Defoff</title>
<style type="text/css">
@charset "utf-8";
#footerDiv{
}
      ...
      <tr> 
				...
				<td width="697" align="center">
					...
					<table width="696" cellspacing="0" cellpadding="1" border="0" bgcolor="#FFFFFF">
						...
						<br>
							Hi, <br> <br>
							Welcome to  Shinde-Masala-Store<br>
          					<a href="'.$reset_link.'">'.$reset_link.'</a>.<br>
						<br>
						Sincerely, <br>
						The Shinde-Masala-Store Team <br><br>
						</div> 
						</td> </tr>
					</table>
	...
	<tr> 	
  	<td align="center" valign="top" style="height:10px;line-height:10px;font-size:10px;padding:0px 0 0px 0;">
    	<div id="footerDiv" style="font-family:Lucida Grande,Arial,Helvetica,Geneva,Verdana,sans-serif;color:#FFFFFF;font-size:12px;line-height:1em;text-align:center;padding:8px 10px 12px 10px;">
			Copyright &copy; <a href="'.$site_path.'" style="text-decoration:none; color:#fff;">The Shinde-Masala-Store</a> '.date('Y').' All rights reserved. </div>
    </td>
	</tr>
	</table>  
  </td>
